...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-22 19:30`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/85f79bce-1064-4a0c-99dd-51ffe7067843.git
$ cd 85f79bce-1064-4a0c-99dd-51ffe7067843
```
